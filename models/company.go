...
type MstrCompany struct {
	...
	StorageType     string         `json:"storage_type" gorm:"type:varchar(10);comment:Storage for company"`
	ReportType      string         `json:"report_type" gorm:"type:varchar(10);comment:Report for company"`
	...
	CompanyTimezone string         `json:"company_timezone" gorm:"type:varchar(50);comment:Company timezone identifier"`
