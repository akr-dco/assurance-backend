...
func SetupRoutes(router *gin.Engine) {
	...
	public := router.Group("/api")
	{
		...
		public.GET("/report/assurance-download-json", controllers.AssuranceDownloadJSON)
	...
	api := router.Group("/api", middleware.APIKeyAuth(), middleware.AuthMiddleware(), middleware.CheckCompanyActive())
	{
		...
		//REPORT
		api.GET("/report-local/assurance-download-json", controllers.GetAssuranceDownloadJson)
		api.GET("/report-local/assurance-failure", controllers.GetAssuranceFailure)
		api.GET("/report-local/admin-summary", controllers.AdminSummaryReport)

		//TRN SAM ADHOC
		api.POST("/sam-adhoc/", controllers.CreateTrxSamAdhoc)

		//DECRALATION
		api.GET("/mstr-declaration/filter", controllers.GetFilteredDeclaration)
		api.POST("/mstr-declaration", controllers.CreateDeclaration)
		api.PUT("/mstr-declaration/:id", controllers.UpdateDeclarationByID)
		api.DELETE("/mstr-declaration/:id", controllers.DeleteDeclarationByID)
